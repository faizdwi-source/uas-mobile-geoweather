...
* **Tanggung Jawab Demo:** Atta Rizal Aurel Fajri.
...
* **Tanggung Jawab Demo:** Moh. Faiz Dwi Hermawan.
...
* **Tanggung Jawab Demo:** Raihan Maulana Asyam.
...
1. **Clone Repositori:**
   ```bash
   git clone [https://github.com/faizdwi-source/uas-mobile-geoweather.git](https://github.com/faizdwi-source/uas-mobile-geoweather.git)
